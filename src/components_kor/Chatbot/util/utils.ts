// import { fetchRsos } from '@/entities/universe/rsos/api/fetch-rsos';
...
// export const getRandomSatellite = async () => {
//   try {
//     const result = await fetchRsos();
//     const satellites = Object.values(result).slice(0, 100);
//     const randomIndex = Math.floor(Math.random() * satellites.length);
//     const randomSat = satellites[randomIndex];
//     const randomSatelliteName = randomSat.objectname;
//     return randomSatelliteName;
//   } catch (error) {
